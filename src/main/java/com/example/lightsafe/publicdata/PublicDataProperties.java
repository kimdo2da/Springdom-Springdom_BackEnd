...
public class PublicDataProperties {
    ...
    public static class Geocoding {
        ...
        /**
         * 주소만 있고 좌표가 없는 보안등을 카카오 주소검색으로 변환할지 여부.
         */
        private boolean enabled = true;

        /**
         * 한 번 실행할 때 카카오에 물어볼 주소 수 상한.
         *
         * 카카오 로컬 API 는 하루 10만 건까지입니다. 주소검색에서 못 찾으면 키워드검색으로
         * 한 번 더 물어보므로 주소 하나가 최대 2건을 씁니다. 2000개 × 24시간이면
         * 하루 4.8만~9.6만 건이라 한도 안에 들어옵니다.
         *
